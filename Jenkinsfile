...
node('ca-jenkins-agent') {
    ...
    pipeline.protectedBranches.addMap([
        ...
        [name: "next", tag: "next", dependencies: ["@zowe/imperative": "next"]],
    ...
    pipeline.createStage(
        name: "Codecov",
        stage: {
            withCredentials([usernamePassword(credentialsId: 'CODECOV_ZOWE_CICS', usernameVariable: 'CODECOV_USERNAME', passwordVariable: 'CODECOV_TOKEN')]) {
