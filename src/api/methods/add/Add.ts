 ...
 */
export async function addCSDGroup(session: AbstractSession, parms: ICSDGroupParms): Promise<ICMCIApiResponse> {
    validateCSDGroupParms(parms);
...
function validateCSDGroupParms(parms: ICSDGroupParms) {
